...
let currentPage = 'pos'; // pos | laba-rugi | neraca
let branchesData = [];
...
// Render Kerangka Utama (Navbar + Container)
...
// Render isi halaman berdasarkan state currentPage
...
// =================================================================
// LOGIC KASIR (Sama seperti sebelumnya, dibungkus fungsi)
// =================================================================
...
async function loadProducts() {
    ...
    if(!grid) return; // Guard if page changed
...
window.navigate = function(page) {
    currentPage = page;
    renderShell(); // Re-render everything to switch pages
}
